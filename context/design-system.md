...
## Learnings
- [2026-08-15] After each well-defined Workbench build phase passes its written
  completion checks and Steve and the builder agree it is finished, automatically create a
  source-backed creative infographic plus receipt. The project-local `phase-infographic` skill
  is a manual rerun or repair option, not a step Steve should have to request.
