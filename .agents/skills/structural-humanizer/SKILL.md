...
- **End hot.** Stop at the spike instead of the quiet coda (see Codex fingerprint).

## Model fingerprints (know what drafted the text)

Most drafts here come from Codex, whose fingerprint is the most distinctive of all
five models. If the draft is Codex: **flat event escalation** (uniform intensity
